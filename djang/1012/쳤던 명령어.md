...
class Post(models.Model):
    ...
    main_image = models.ImageField(upload_to='blog/%Y/%m/%d/', blank=True, null=True) # media/blog를 가리킴 년월일로 표시하겠다는 명령어
